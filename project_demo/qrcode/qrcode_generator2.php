...
function myFunction() {
    ...
    alert("<div><iframe src=\u0022http:\u005C\u005C140.123.175.103:8888\u005Cproject_demo\u005Cqrcode\u005Ciframe_qrcode2.php?ID="+ID+"\u0022  frameborder=\u00220\u0022 scrolling=\u0022no\u0022>很抱歉，您的瀏覽器不支援浮動框架，所以無法顯示此框架的內容！</iframe></div>");
}
</script>
