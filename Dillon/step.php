...
echo "</script>";
//-----------------------------------------------------------發票生成//加資料夾tmp image
define("QRCODE_PATH", "D:/AppServ/www/lt_envico/");
...
imagepng($img, $save);*/
//--------------------------------------------------------圖片轉檔
require_once(QRCODE_PATH.'../php_image_magician/php_image_magician.php');
...
$magicianObj1 = new imageLib(QRCODE_PATH.'../image/123456.png');
//$magicianObj1 -> resizeImage(500, 1000);
$magicianObj1 -> saveImage(QRCODE_PATH.'../output_combine.bmp', 100);
//--------------------------------------------------------列印圖片
printer_draw_bmp($handle, QRCODE_PATH."../output_combine.bmp", 1, 1);
